...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/dpeth.ipc",
			endpoint:    "/data/testnet/dpeth.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/dpeth.ipc",
			endpoint:    "/data/testnet/dpeth.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/dpeth.ipc",
			endpoint:    "/data/testnet/dpeth.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/dpeth.ipc",
			endpoint:    "/data/testnet/dpeth.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
