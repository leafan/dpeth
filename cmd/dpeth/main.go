...
// dpeth is the official command-line client for DPETH.
package main
...
import (
	...
	"github.com/eeefan/dpeth/console"
	"github.com/eeefan/dpeth/eth"
	"github.com/eeefan/dpeth/ethclient"
	"github.com/eeefan/dpeth/internal/debug"
...
const (
	clientIdentifier = "dpeth" // Client identifier to advertise over the network
)
...
var (
	...
	app = utils.NewApp(gitCommit, "the dpeth command line interface")
...
// dpeth is the main entry point into the system if no special subcommand is ran.
// It creates a default node based on the command line arguments and runs it in
// blocking mode, waiting for it to be shut down.
func dpeth(ctx *cli.Context) error {
