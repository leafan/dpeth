...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "dpeth.ipc", false, filepath.Join(os.TempDir(), "dpeth.ipc")},
		{"data", "dpeth.ipc", false, "data/dpeth.ipc"},
		{"data", "./dpeth.ipc", false, "./dpeth.ipc"},
		{"data", "/dpeth.ipc", false, "/dpeth.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "dpeth.ipc", true, `\\.\pipe\dpeth.ipc`},
		{"data", "dpeth.ipc", true, `\\.\pipe\dpeth.ipc`},
		{"data", `\\.\pipe\dpeth.ipc`, true, `\\.\pipe\dpeth.ipc`},
	}
