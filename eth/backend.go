...
import (
	...
	"github.com/eeefan/dpeth/core/bloombits"
...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	if chainConfig.Alien != nil {
		...
		if config.NetworkId == 1 { //eth.DefaultConfig.NetworkId
			// change default eth networkid  to default dpeth networkid
	...
	log.Info("Initialising dpeth protocol", "versions", ProtocolVersions, "network", config.NetworkId)
