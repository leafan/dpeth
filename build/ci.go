...
import (
	...
	"github.com/eeefan/dpeth/internal/build"
)
...
var (
	...
	debExecutables = []debExecutable{
		...
		{
			Name:        "dpeth",
			Description: "dpeth Protocol CLI client.",
		},
		{
			Name:        "puppeth",
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/eeefan/dpeth/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/eeefan/dpeth/mobile")
